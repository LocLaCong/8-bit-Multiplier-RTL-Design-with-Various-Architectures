...
HD_PWD='C:/Users/Admin/Nhan_RCA_last/Nhan_RCA_last.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Nhan_RCA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Nhan_RCA.tcl
