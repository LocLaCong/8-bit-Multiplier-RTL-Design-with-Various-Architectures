...
HD_PWD='C:/Users/Admin/Nhan_CLA_last/Nhan_CLA_last.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Nhan_CLA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Nhan_CLA.tcl
