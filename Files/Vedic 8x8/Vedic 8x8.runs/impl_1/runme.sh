...
HD_PWD='C:/Users/Admin/Vedic 8x8/Vedic 8x8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Vedic_8x8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Vedic_8x8.tcl -notrace
