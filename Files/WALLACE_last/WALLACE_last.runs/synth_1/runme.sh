...
HD_PWD='C:/Users/Admin/WALLACE_last/WALLACE_last.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WAlLACE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WAlLACE.tcl
