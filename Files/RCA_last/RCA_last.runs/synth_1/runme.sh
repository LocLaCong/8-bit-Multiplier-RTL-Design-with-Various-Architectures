...
HD_PWD='C:/Users/Admin/RCA_last/RCA_last.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FA8b_CLA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FA8b_CLA.tcl
