...
HD_PWD='C:/Users/Admin/Vedic_last/Vedic_last.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Vedic_8x8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Vedic_8x8.tcl
