...
HD_PWD='C:/Users/Admin/CLA_last/CLA_last.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CLA_8bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CLA_8bit.tcl
