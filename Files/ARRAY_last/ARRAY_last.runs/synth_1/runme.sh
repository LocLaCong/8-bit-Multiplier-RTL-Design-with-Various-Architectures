...
HD_PWD='C:/Users/Admin/ARRAY_last/ARRAY_last.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ARRAY.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ARRAY.tcl
